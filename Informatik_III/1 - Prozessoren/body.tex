...
Anmerkung zu Intel 4004: Die Befehlsbreite ist 8-Bit, es stehen 46 Befehle zur Verfügung.
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Der \enquote{Pufferüberlauf} gehört zu den häufigsten Sicherheitslücken in Programmen (mit Computern mit der Von-Neumann-Architektur).
	  ...
	  \begin{solutionordottedlines}[2cm]
	  Bei der klassischen Harvard Architektur sind Programmcode (Programmdaten) und Nicht-Programmdaten in physisch getrennten Speichern abgelegt. Somit können Nicht-Programmdaten nicht auf \enquote{falsche} Programmdaten zeigen, was bei der Von-Neumann-Architektur aber durchaus möglich wäre, weil Programmdaten und Nicht-Programmdaten im selben Speicher liegen.
	  \end{solutionordottedlines}
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{solutionordottedlines}[2cm]
	Man unterscheide Daten- und Adressbus, deren Breiten sich unterscheiden können. Der adressierbare Speicher hängt von der Breite des Adressbuses ab.
	\end{solutionordottedlines}
